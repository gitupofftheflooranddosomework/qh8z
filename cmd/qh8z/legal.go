...
func (a *app) pricingPage(w http.ResponseWriter, r *http.Request) {
	a.policyPage(w, r, "Pricing", policies.Pricing)
}
...
</style></head><body><header><a class="brand" href="/">qh8z</a><nav><a href="/pricing">Pricing</a><a href="/terms">Terms</a><a href="/privacy">Privacy</a><a href="/acceptable-use">Acceptable Use</a></nav></header><main><article>`))
