...
test('validates custom slugs and reserved words', () => { assert.equal(normalizeSlug('Hello_123'), 'Hello_123'); assert.throws(() => normalizeSlug('api')); assert.throws(() => normalizeSlug('reset')); assert.throws(() => normalizeSlug('x')); });
